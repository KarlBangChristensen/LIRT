...
proc sgplot data=plot;
	band x=interval lower=it1_pct1 upper=it1_pct99 / fillattrs=(color=lightgrey);
	band x=interval lower=it1_pct5 upper=it1_pct95 / fillattrs=(color=darkgrey);
	series y=it1_mean x=interval / lineattrs=(thickness=3 pattern=1 color=black);
run;
